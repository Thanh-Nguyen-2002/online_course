            ...
            <div className="max-w-[1700px] mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-1">
                    ...
                    <ul className="space-y-2">
                        <li><a href="#" className="text-gray-300 hover:text-[#0EA5E9] transition-colors duration-200 text-sm">Về chúng tôi</a></li>
                        <li><a href="#" className="text-gray-300 hover:text-[#0EA5E9] transition-colors duration-200 text-sm">Khóa học</a></li>
